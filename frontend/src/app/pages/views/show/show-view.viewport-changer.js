			...
			<div className="col-2 d-flex justify-content-end">
				<div className="btn-group" role="group">
					...
					<button
						...
						className={`btn btn-outline btn-secondary ${viewportSize === 'desktop' && 'active'}`}
					>
					...
					<button
						...
						className={`btn btn-outline btn-secondary ${viewportSize === 'tablet' && 'active'}`}
					>
					...
					<button
						...
						className={`btn btn-outline btn-secondary ${viewportSize === 'phone' && 'active'}`}
					>
