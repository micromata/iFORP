...
export const Pages = () => (
  <React.Fragment>
    <Switch>
      ...
      <Route
        exact
        path="/whiteboards/project/:projectId/whiteboard/:whiteboardId"
        component={Whiteboards}
      />
      <Route
        exact
        path="/whiteboards/project/:projectId"
        component={Whiteboards}
      />
      <Route
        exact
        path="/views/show/project/:projectId/whiteboard/:whiteboardId/view/:viewId"
        component={ShowView}
      />
      <Route
        exact
        path="/views/edit/project/:projectId/whiteboard/:whiteboardId/view/:viewId"
        component={EditView}
      />
      <Route
        exact
        path="/library/project/:projectId/whiteboard/:whiteboardId/view/:viewId"
        component={Library}
      />
      <Route
        exact
        path="/library/project/:projectId/whiteboard/:whiteboardId/view/:viewId/upload"
        component={Upload}
      />
      <Route
        render={props => (
